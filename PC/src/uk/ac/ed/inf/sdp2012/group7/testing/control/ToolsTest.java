...
public class ToolsTest {
	...
	public void test1GetAngleFrom0_0() {
		...
		System.out
		.println("Running the first test of getAngleFrom0_0, result: "
				+ actual);
	...
	public void test2GetAngleFrom0_0() {
		...
		System.out
		.println("Running the second test of getAngleFrom0_0, result: "
				+ actual);
		assertTrue(actual == expected);
	}
	...
	public void test3GetAngleFrom0_0() {
		...
		System.out
		.println("Running the third test of getAngleFrom0_0, result: "
				+ actual);
		assertTrue(actual == expected);
	}
	...
	public void test1GetRelativePos() {
		...
		System.out.println("Running the first test of getRelativePos, result: "
				+ actual);
	...
	public void test2GetRelativePos() {
		...
		System.out
		.println("Running the second test of getRelativePos, result: "
				+ actual);
		assertTrue(actual.x == expected.x && actual.y == expected.y);
	}
	...
	public void test1GetAngleToFacePoint() {
		double actual = Tools.getAngleToFacePoint(new Point(1, 1),
				3 * Math.PI / 2, new Point(1, 2));
		double expected = Math.PI / 2;
		System.out
		.println("Running the first test of getAngleToFacePoint, result: "
				+ actual);
		assertTrue(actual == expected);
	}
	...
	public void test2GetAngleToFacePoint() {
		double actual = Tools.getAngleToFacePoint(new Point(1, 1), Math.PI / 2,
				new Point(2, 1));
		double expected = 0;
		System.out
		.println("Running the second test of getAngleToFacePoint, result: "
				+ actual);
		assertTrue(actual == expected);
	}
